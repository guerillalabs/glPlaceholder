(function($){
	...
	$.fn.glPlaceholder = function(method) {
		...
		if (methods[method]) {
			...
			$.error('Method ' +  method + ' does not exist on jQuery.glPlaceholder');
		}    
	};
})(jQuery);
...
jQuery(document).ready(function() {
	if (!Modernizr.input.placeholder) { jQuery('input[placeholder]').glPlaceholder(); }
});